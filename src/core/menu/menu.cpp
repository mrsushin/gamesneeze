...
void style() {
    ...
    colors[ImGuiCol_FrameBg]                = ImVec4(0.333f, 0.650f, 0.745f, 0.62f);
    colors[ImGuiCol_FrameBgHovered]         = ImVec4(0.027f, 0.231f, 0.294f, 0.40f); // BABAG
    colors[ImGuiCol_FrameBgActive]          = ImVec4(0.027f, 0.231f, 0.294f, 0.40f); //(0.12f, 0.80f, 0.06f, 0.67f);
    ...
    colors[ImGuiCol_SliderGrab]             = ImVec4(0.188f, 0.717f, 0.811f, 1.00f);
    colors[ImGuiCol_SliderGrabActive]       = ImVec4(0.70f, 0.70f, 0.70f, 1.00f);
    colors[ImGuiCol_Button]                 = ImVec4(0.066f, 0.584f, 0.741f, 0.62f);
    colors[ImGuiCol_ButtonHovered]          = ImVec4(0.188f, 0.717f, 0.811f, 0.40f);
    colors[ImGuiCol_ButtonActive]           = ImVec4(0.027f, 0.231f, 0.294f, 0.40f);
    ...
    colors[ImGuiCol_Tab]                    = ImVec4(0.066f, 0.584f, 0.741f, 0.62f);
    colors[ImGuiCol_TabHovered]             = ImVec4(0.188f, 0.717f, 0.811f, 0.62f);
    colors[ImGuiCol_TabActive]              = ImVec4(0.027f, 0.231f, 0.294f, 0.62f);
    ...
    colors[ImGuiCol_Header]                 = ImVec4(0.333f, 0.650f, 0.745f, 0.62f);
...
void Menu::drawMenu() {
    ...
    ImGui::TextColored(ImColor(17, 149, 189, 255), "sneeze");
    if (ImGui::IsItemClicked()) {
        system("xdg-open https://discord.gg/SCHsWHFJMb &"); //if it works it works lmao
    }
    if (ImGui::IsItemHovered()) {
    ...
    ImGui::GetStyle().Colors[ImGuiCol_Button] = (Menu::tabSelected == 0) ? ImVec4(0.066f, 0.584f, 0.741f, 0.62f) : ImVec4(0.027f, 0.231f, 0.294f, 0.62f);
    if (ImGui::Button("Legit", bWidth)) {
        Menu::tabSelected = 0;
    } ImGui::SameLine();

   /*
    ImGui::GetStyle().Colors[ImGuiCol_Button] = (Menu::tabSelected == 1) ? ImVec4(0.066f, 0.584f, 0.741f, 0.62f) : ImVec4(0.027f, 0.231f, 0.294f, 0.62f);
    ...
    */
    ...
    ImGui::GetStyle().Colors[ImGuiCol_Button] = (Menu::tabSelected == 2) ? ImVec4(0.066f, 0.584f, 0.741f, 0.62f) : ImVec4(0.027f, 0.231f, 0.294f, 0.62f);
    if (ImGui::Button("Misc", bWidth)) {
        Menu::tabSelected = 2;
    }
    ImGui::GetStyle().Colors[ImGuiCol_Button] = ImVec4(0.066f, 0.584f, 0.741f, 0.62f);
    ImGui::PopStyleVar();
